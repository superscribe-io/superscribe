...
import { EXTENSION_LANGUAGES, EXTENSION_TYPES, BUNDLE_EXTENSION_TYPES } from '@superscribe/constants';
import { create } from '@superscribe/extensions-sdk/cli';

run();

async function run() {
	// eslint-disable-next-line no-console
	console.log('This utility will walk you through creating a Superscribe extension.\n');
