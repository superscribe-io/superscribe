...
export function generateHash(stringToHash) {
    const argon2HashConfigOptions = getConfigFromEnv('HASH_', 'HASH_RAW'); // Disallow the HASH_RAW option, see https://github.com/superscribe/superscribe/discussions/7670#discussioncomment-1255805
