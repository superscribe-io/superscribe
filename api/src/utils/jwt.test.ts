...
import type { SuperscribeTokenPayload } from '../../src/types/index.js';
import { verifyAccessJWT, verifyJWT } from '../../src/utils/jwt.js';

const payload: SuperscribeTokenPayload = { role: null, app_access: false, admin_access: false };
...
const RequiredEntries: Array<keyof SuperscribeTokenPayload> = ['role', 'app_access', 'admin_access'];
