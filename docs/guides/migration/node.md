---
description: Learn how to migrate your data model to a new Superscribe project using Node.js.
tags: []
skill_level:
...
You should have two Superscribe projects - this guide will refer to them as the "base" and the "target". Before starting,
...
const BASE_DIRECTUS_URL = 'https://your-base-project.superscribe.app';
const BASE_ACCESS_TOKEN = 'your-access-token';

const TARGET_DIRECTUS_URL = 'https://your-target-project.superscribe.app';
