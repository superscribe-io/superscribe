---
description:
  Superscribe supports internationalization across the entire App. Many languages are currently supported, with more being
...
Our [Crowdin](https://locales.superscribe.io) page provides an external interface for managing all of the different
...
1. Navigate to [Crowdin](https://locales.superscribe.io)
...
to a Core Team member via [Discord](https://superscribe.chat).
