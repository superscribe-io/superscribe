---
description: REST and GraphQL API documentation for file access and management in Superscribe.
...
> tracked within the `superscribe_files` system collection. Any requested file transformations are handled on the fly, and
...
example.com/assets/1ac73658-8b62-4dea-b6da-529fbc9d01a4/superscribe-logo.png
```
...
there, it is recommended that you always use the Superscribe API. This is the only way that you can take advantage of file
permissions and other built-in features.

:::

![Original File](https://cdn.superscribe.io/docs/v9/reference/files/original-20220216A.jpg) _Original File Used — 602KB and
1800x1200_
...
```html
<a href="https://your-superscribe.com/assets/<file-id>?download" target="_blank" download="Your File.pdf">Download</a>
```
...
For even more advanced control over the file generation, Superscribe exposes
...
| 25%                                                                                             | 50%                                                                                             | 75%                                                                                             | 100%                                                                                               |
| ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------- |
| ![25%](https://cdn.superscribe.io/docs/v9/reference/files/200-200-cover-25-20220216A.jpg)<br>_4KB_ | ![50%](https://cdn.superscribe.io/docs/v9/reference/files/200-200-cover-50-20220216A.jpg)<br>_6KB_ | ![75%](https://cdn.superscribe.io/docs/v9/reference/files/200-200-cover-75-20220216A.jpg)<br>_8KB_ | ![100%](https://cdn.superscribe.io/docs/v9/reference/files/200-200-cover-100-20220216A.jpg)<br>_38KB_ |
...
`metadata` **object**\
Any additional metadata Superscribe was able to scrape from the file. For images, this includes EXIF, IPTC, and ICC information.
...
List all files that exist in Superscribe.
...
```graphql
type Query {
	files_by_id(id: ID!): superscribe_files
}
```
...
```graphql
type Mutation {
	import_file(url: String!, data: create_superscribe_files_input!): superscribe_files
}
```
...
```graphql
type Mutation {
	update_files_item(id: ID!, data: update_superscribe_files_input!): superscribe_files
}
```
...
```graphql
type Mutation {
	update_files_items(ids: [ID!]!, data: update_superscribe_files!): [superscribe_files]
}
```
