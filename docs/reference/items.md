---
description: REST and GraphQL API documentation to access and manage Items in Superscribe.
readTime: 5 min read
...
Superscribe. For the sake of documentation, we'll use a fictional articles collection with the following fields: `id`,
...
List all items that exist in Superscribe.
...
Get an item that exists in Superscribe.
