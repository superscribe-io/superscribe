---
description: REST and GraphQL API documentation to run queries in Superscribe.
readTime: 9 min read
...
> Most Superscribe API Endpoint operations can be manipulated with the following parameters. It is important to understand
...
Find all items that mention Superscribe\
`Superscribe`
...
The following aggregation functions are available in Superscribe:
