---
description: An introduction to the REST and GraphQL APIs in Superscribe.
readTime: 7 min read
...
> Superscribe offers both a REST and GraphQL API to manage the data in the database. The API has predictable
...
Superscribe only retrieves the fields in your items that explicitly have been requested. Relational data can be retrieved
...
this item. To update an existing item, simply provide the primary key with the updates, and Superscribe will treat it as an
...
[we'd love to hear your thoughts](https://github.com/superscribe/superscribe/discussions/new).
...
Below are the global error codes used within Superscribe, and what they mean.
