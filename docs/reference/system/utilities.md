---
description: REST and GraphQL API documentation on the Utilities collection in Superscribe.
readTime: 3 min read
...
Resets both the data and schema cache of Superscribe. This endpoint is only available to admin users.
