---
description: A guide on how to build custom Panels in Superscribe.
readTime: 3 min read
---
...
The panel component is the part of your extension that will be rendered by the Superscribe App whenever your panel should
