...
loading your operation, this object is imported by the Superscribe App host.
...
your operation, this object is imported by the Superscribe API host.
...
The extension id needs to be identical for both entrypoints in order for Superscribe to recognize them as part of the same
extension.
