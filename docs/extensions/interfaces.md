---
description: A guide on how to build custom Interfaces in Superscribe.
readTime: 4 min read
---
...
is imported by the Superscribe host.
...
The interface component is the part of your extension that will be rendered by the Superscribe App whenever your interface
...
component, it should be emitted to the Superscribe App by using the `input` emit.
...
Other than this simple API to communicate with the Superscribe App, the interface component is a blank canvas, allowing you
