---
description: A guide on how to build custom Layouts in Superscribe.
readTime: 4 min read
---
...
The layout component is the part of your extension that will be rendered by the Superscribe App whenever your layout should
...
Other than this simple API to communicate with the Superscribe App and the system to share state between components, the
layout component is a blank canvas, allowing you to create anything you need.

The `@superscribe/extensions-sdk` package provides some useful composables to help with creating layouts:
