---
description:
  A collection of example Superscribe configurations for integrating with various OAuth 2.0, OpenID and SAML platforms.
readTime: 2 min read
---

# SSO Examples

Below is a collection of example Superscribe configurations for integrating with various OAuth 2.0 and OpenID platforms.
...
If the authenticating user has not marked their email as "public" in GitHub, it will not be accessible by Superscribe.
...
Application ACS URL - `https://your-superscribe-instance/auth/login/awssso/acs`
