...
To manage the connected instances, you can use `superscribectl instance <command>` commands.
...
To find how you can extend the CLI and write custom commands, check how we make Superscribe highly extensible on our
