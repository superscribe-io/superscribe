---
description: An introduction to what Superscribe is, how it works, who it is for, and when to use it.
readTime: 8 min read
---

# Introduction

> These Docs will help you get Superscribe up-and-running quickly, guide you through advanced features, and explain the
> core concepts that make Superscribe so unique.

## What is Superscribe?

::: tip Superscribe

Superscribe ([duh REKT iss](http://audio.pronouncekiwi.com/Salli/Superscribe)) is Latin for: _laid straight, arranged in
lines_.\
...
**Superscribe is an Open Data Platform built to democratize the database.**\
This platform provides everyone on your team, _regardless of technical skill_, equal access to data and digital file asset
management, for any data model or project. First, link Superscribe to your desired SQL database and file storage adapter. After
that, Superscribe enables you to perform CRUD operations, create users, assign roles with fully configurable permissions, build
...
SQL flavors all come with slightly different data types and idiosyncrasies. Superscribe uses [Database Introspection](#how-it-works)
to read your database structure and create an abstraction layer to handle all the nitty-gritty details behind the scenes.
This technique works seamlessly with any major SQL database. It also lets you link Superscribe to your new or pre-existing database
or remove it anytime, with no impact on your existing data model. That means you'll never encounter vendor lock-in.

**The App and APIs**\
Once your database is introspected and abstracted, Superscribe dynamically generates REST and GraphQL API endpoints to manage
...
This architecture is how Superscribe democratizes the database and provides control to [the whole team](#who-s-it-for).

**Open-Source, Modular, Extensible, Scalable**\
At the highest level, Superscribe organizes its features and functionality into Modules. Each Module allows you to interact
with data in some specific way, such as data and content management, digital file asset management, drag and drop analytics
dashboard creation, or whatever. If you find Superscribe is missing something that your project needs, no problem!

Built entirely in Typescript, primarily on [Node.js](https://nodejs.dev) and [Vue.js](https://vuejs.org), Superscribe is
...
Get a project running in minutes. Learn Superscribe hands-on in the [Quickstart Guide](/getting-started/quickstart).

:::

## How It Works

**Superscribe is installed as a _layer_ on top of your new or existing SQL database.**
...
That is not the case with Superscribe. Superscribe gives you direct access to your pure and unaltered data. That means you
have the option to bypass the Superscribe middleware (API, SDK, App) and connect to your data with proper SQL queries. This
...
**Superscribe lets the whole team work together and access data in one place.**
...
:::tip Superscribe Vocabulary

To keep things simpler, _especially for the no-code users_, Superscribe uses friendlier names for many database terms and
...
<!--
@TODO getting-started > learn-superscribe
For more information on Superscribe-specific terms, see the guide on [how to learn Superscribe](/getting-started/learn-superscribe).
-->

:::

<!--
:::tip Ready to see what Superscribe can do?

Checkout the core features and learn Superscribe hands-on in the [Quickstart Guide](/getting-started/quickstart).
...
**Superscribe can power any data-driven project and can be linked or removed at any time.**

Build, monitor or manage any data model or app you desire: IoT fleets, e-commerce, SaaS, business data analytics,
multi-channel content, _or anything else!_ If it involves SQL and digital files, you can link up Superscribe. With this in
...
webhooks and task automation. Completely detached from the database, you're free to link and remove Superscribe anytime or use
...
**Superscribe is a simple, data-first solution to complex problems with no downsides.**

Superscribe was created in 2004 and has been slowly, iteratively improved on for a long time. The core team has carefully
...
scalability, migration options, etc.. all match the project in question. However, with Superscribe, that's not the case!
...
- **Open** — Superscribe Core is open source, with no obfuscated or cloud-only code.
...
**Superscribe Cloud is the fastest and easiest way to get your Superscribe Projects going.**

Cloud architecture can be complicated and resource-intensive. Superscribe Cloud provides scalable, optimized storage and
infrastructure, and automatic updates so developers can focus on the app's core business logic. Superscribe Cloud also
offers [Cloud Exclusive Extensions](/cloud/glossary#cloud-exclusives), enhancing Superscribe Core with even more features.

With your free Superscribe Cloud account, you can set up Teams to organize Projects, Project billing, and other Team
...
:::tip Ready to try Superscribe Cloud?

Set up your free Cloud account and learn Superscribe hands-on in the [Quickstart Guide](/getting-started/quickstart).

:::

:::tip Enterprise Cloud

Need advanced configuration, unlimited scalability, and dedicated support? [Contact us](https://superscribe.io/contact)
