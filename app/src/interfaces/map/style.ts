...
export function getMapStyle() {
	...
	return [
		...
		{
			id: 'superscribe-polygon-midpoint',
			type: 'circle',
		...
		{
			id: 'superscribe-polygon-and-line-vertex',
			type: 'circle',
