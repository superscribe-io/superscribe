		...
		<div class="container" :class="{ wide }">
			<div class="title-box">
				...
				<div v-else class="logo" :style="{ backgroundColor: info?.project?.project_color }">
					<img src="./logo-light.svg" alt="Superscribe" class="superscribe-logo" />
				</div>
				<div class="title">
...
const colors = computed(() => {
	...
	/**
	 * The default light mode secondary color is based on the standard difference between Superscribe purple and pink, which is:
