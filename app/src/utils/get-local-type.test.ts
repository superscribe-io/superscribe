...
test('Returns FILE for m2o relations to superscribe_files', () => {
	const fieldsStore = useFieldsStore();
...
test('Returns O2M', () => {
	...
	expect(getLocalTypeForField('superscribe_files', 'test_field')).toBe('o2m');
});
...
test('Returns TRANSLATIONS for special M2M relations', () => {
	...
	expect(getLocalTypeForField('superscribe_files', 'test_field')).toBe('translations');
});
...
test('Returns FILES for M2M relations to superscribe_files', () => {
	const fieldsStore = useFieldsStore();
	...
	(relationsStore.getRelationsForField as Mock).mockReturnValue([
		{
			collection: 'collection_a_superscribe_files',
			field: 'collection_a_id',
			related_collection: 'collection_a',
			meta: {
				many_collection: 'collection_a_superscribe_files',
				many_field: 'collection_a_id',
				one_collection: 'collection_a',
				one_field: 'relation',
				one_collection_field: null,
				one_allowed_collections: null,
				junction_field: 'superscribe_files_id',
				sort_field: null,
				one_deselect_action: 'nullify',
			},
		},
		{
			collection: 'collection_a_superscribe_files',
			field: 'superscribe_files_id',
			related_collection: 'superscribe_files',
			meta: {
				many_collection: 'collection_a_superscribe_files',
				many_field: 'superscribe_files_id',
				one_collection: 'superscribe_files',
				one_field: null,
				one_collection_field: null,
				one_allowed_collections: null,
