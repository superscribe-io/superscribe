...
describe('Alterations', () => {
	describe('files', () => {
		it('autoGenerateJunctionRelation has changed', () => {
			...
			expect(fieldDetailStore.relations.m2o?.related_collection).toEqual('superscribe_files');
			expect(fieldDetailStore.relations.m2o?.field).toEqual('superscribe_files_id');
