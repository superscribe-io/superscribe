import { defineModule } from '@superscribe/utils';
...
const checkForSystem: NavigationGuard = (to, from) => {
	...
	if (to.params.collection === 'superscribe_users') {
	...
	if (to.params.collection === 'superscribe_files') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'superscribe_activity') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'superscribe_webhooks') {
		if (to.params.primaryKey) {
	...
	if (to.params.collection === 'superscribe_presets') {
		if (to.params.primaryKey) {
